...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "CRM regional para o agronegócio" },
      { property: "og:title", content: "AgroGestão CRM" },
      { name: "twitter:title", content: "AgroGestão CRM" },
      { property: "og:description", content: "CRM regional para o agronegócio" },
      { name: "twitter:description", content: "CRM regional para o agronegócio" },
